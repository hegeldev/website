...
- Want to *use* Hegel? [hegel-rust](https://github.com/hegeldev/hegel-rust), [hegel-go](https://github.com/hegeldev/hegel-go), [hegel-cpp](https://github.com/hegeldev/hegel-cpp), and [hegel-typescript](https://github.com/hegeldev/hegel-typescript) are fully-fledged property-based testing libraries, built on Hegel.
