...
- Want to *use* Hegel? [hegel-rust](https://github.com/hegeldev/hegel-rust) and [hegel-go](https://github.com/hegeldev/hegel-go) are fully-fledged property-based testing libraries, built on Hegel.
