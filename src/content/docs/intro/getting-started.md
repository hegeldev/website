...
- Want to *use* Hegel? [hegel-rust](https://github.com/hegeldev/hegel-rust), [hegel-go](https://github.com/hegeldev/hegel-go), and [hegel-cpp](https://github.com/hegeldev/hegel-cpp) are fully-fledged property-based testing libraries, built on Hegel.
